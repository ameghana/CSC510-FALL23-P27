...
| Our Team | 27 |
| Evaluation Team | N |
| Project Link | Constable Github Action(N)-https://github.com/palash03/constable-github-action|

Total Assessment : 63

Area|Assessment|Evidence|
|----|---------|---------|
Video 1|3|https://www.youtube.com/watch?app=desktop&v=NXANSl0S1xA|
Video 2|3|Reference https://www.youtube.com/watch?app=desktop&v=GfjyQW7QYaA|
Workload is spread over whole team|2|Yes reference https://github.com/palash03/constable-github-action/graphs/contributors|
Everyone is contributing|2|Yes we can reference almost everyone as contributor in every file|
Number of commits	|2|105 total commits|
Number of commits by different people|2|https://github.com/palash03/constable-github-action/graphs/contributors.Sravan Kumar matta ->3,Nikhila Nathani->15,Palash Gupta->7,Ayush Jain->3,Pushkar Dravid->5.Rest of the commits were from previous team|
Lots of issue reports|2|4 issues total;https://github.com/palash03/constable-github-action/issues|
Issues are being closed|2|4 closed issues -> reference https://github.com/palash03/constable-github-action/issues?q=is%3Aissue+is%3Aclosed%20| 
DOI badge exists|3|DOI badge exists on -> https://github.com/palash03/constable-github-action/blob/main/README.md|
Docs: doco generated, not ugly|0|No docs folder found|
Docs: what: point descriptions of each class/function (in isolation)|0|Docs folder doesn’t exist and classes in any folder don’t have comments|
Docs: how: for common use cases X, Y, Z mini tutorials show worked examples on how to do X, Y, Z|3|Example shown in https://github.com/palash03/constable-github-action/blob/main/README.md file and also in https://www.youtube.com/watch?app=desktop&v=GfjyQW7QYaA|
Docs: why: docs tell a story, provide motivation, give a punchline|2|Readme has all the explanations regarding project|
Docs: short video, animated, hosted on repo|3|https://www.youtube.com/watch?v=GfjyQW7QYaA|
Use of version control tools|3|GitHub is used for the project and also to host it|
Use of style checkers|3|https://github.com/palash03/constable-github-action/blob/main/CONTRIBUTING.md|
Code formatters|2|Used in .py files|
Use of syntax checkers|2|Used in .py files|
Use of code coverage|1|Code coverage badge exists in assets folder. Reference https://github.com/palash03/constable-github-action/blob/main/assets/coverage-badge.svg?short_path=4d82fcb|
Other automated analysis tools|0|No config files found|
Test cases exist|3|All tests exists -> Refer https://github.com/palash03/constable-github-action/blob/main/web/test_constable.py|
Test cases are routinely executed|3|Unit tests and routine test cases run in workflows -> reference https://github.com/palash03/constable-github-action/tree/main/.github/workflows|
The files CONTRIBUTING.md lists coding standards and tips on how to extend the system|3|Yes -> https://github.com/palash03/constable-github-action/blob/main/CONTRIBUTING.md|
...
Evidence the whole team is using the same tools: everyone can get to all tools/files|3|Yes ,everyone in the team are contributing to the files in templates folder|
Evidence the whole team is using the same tools: config files in repo, updated by lots of different people|3|Config files are updated by all members of the team|
Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate system running on their computer)|3|Yes,there is a requirements.txt file with all dependencies->https://github.com/palash03/constable-github-action/blob/main/web/requirements.txt|
...
Short release cycles|2|Yes but only 1 releases -> reference https://github.com/palash03/constable-github-action/releases|
